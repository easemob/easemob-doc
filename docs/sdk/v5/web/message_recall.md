...
- You can adjust the message recall period, up to 7 days, on the **Chat** > **Features > Message & Conversation** page of the [EasyIM Console](https://console.easyim.ai/user/login).
