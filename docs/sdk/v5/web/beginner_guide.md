...
| Step            | Description | 
| :-------------- | :----- | 
| [Register an account](/product/console/account_register.html#注册账号)  | Before using EasyIM, first go to the [EasyIM Console](https://console.easemob.com/user/login) to [register an account](/product/console/account_register.html#注册账号).<br/>Your EasyIM account uniquely identifies you as a developer in the EasyIM Console. Use the account to log in to the console and configure and manage apps. When integrating your app with EasyIM, map the EasyIM accounts to the accounts in your app. |
