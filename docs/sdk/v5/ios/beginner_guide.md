...
| Integrate features | Integrate the main features:<br/> - [Message management](message_send.html) <br/> - [Conversation management](conversation_overview.html)<br/> - [Chat group management](group_overview.html) <br/> - [Chat room management](room_overview.html) <br/> - [User management](user_relationship.html)<br/> - [Offline push](/document/ios/push/push_overview.html) |
