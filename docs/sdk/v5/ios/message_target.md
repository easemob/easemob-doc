...
- **Chat group message roaming:** Roaming is not supported for targeted chat group messages by default. To use it, contact the EasyIM business manager to enable it.
