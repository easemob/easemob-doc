...
- You can adjust the recall period on the **Instant Messaging > Basic Features > Messages** page in the [Easemob Console](https://console.easemob.com/user/login). The maximum is 7 days.
