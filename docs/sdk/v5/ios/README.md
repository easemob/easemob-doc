...
The EasyIM iOS SDK documentation currently covers message, chat group, and chat room capabilities. Documentation for additional SDK capabilities will be added as it becomes available.
...
| [Offline push](/sdk/v5/ios/push/push_overview.html) | Provides APNs-based offline push configuration and notification management. |

## Explore the documentation

- [Message Overview](message_overview.html)
- [Chat Group Overview](group_overview.html)
- [Chat Room Overview](room_overview.html)
