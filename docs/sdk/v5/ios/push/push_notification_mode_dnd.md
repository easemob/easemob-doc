...
[Push notification modes](push_notification_mode_dnd.html#push-notification-modes) and [Do Not Disturb](push_notification_mode_dnd.html#do-not-disturb) are advanced push features. Before using them, enable them for free in the [Easemob Console](https://console.easemob.com/user/login). **After activation, to disable advanced push features, you must contact the Easemob business team because this operation deletes all configurations related to the advanced features.**
