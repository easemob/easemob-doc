...
Upload the APNs push certificate in [Easemob Console](https://console.easemob.com/user/login).

1. Log in to [Easemob Console](https://console.easemob.com/user/login), select your app > **Feature Configuration** > **Value-Added Features** > **Push**.
...
2. Send a test message in [Easemob Console](https://console.easemob.com/user/login).
...
2. Check whether the correct APNs certificate was uploaded in [Easemob Console](https://console.easemob.com/user/login) and whether the correct certificate environment was set.
