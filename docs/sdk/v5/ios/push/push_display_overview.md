...
1. **Configure push notification display attributes**: Use the default title and content. The display style `EMPushDisplayStyle` uses its default value (`EMPushDisplayStyleSimpleBanner`). The title is **You've got a new message** and the content is **Please click to view**.
