...
1. Log in to [Easemob Console](https://console.easemob.com/user/login). On the **App Management** page, click the App Key of the test or production app.
...
4. Send a test message in [Easemob Console](https://console.easemob.com/user/login).
