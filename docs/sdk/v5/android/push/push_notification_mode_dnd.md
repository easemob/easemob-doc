...
[Push notification mode](push_notification_mode_dnd.html#push-notification-mode) and [Do Not Disturb mode](push_notification_mode_dnd.html#do-not-disturb-mode) are advanced push features. Before using them, you need to enable them for free in [Easemob Console](https://console.easemob.com/user/login). **After activation, if you need to disable advanced push features, you must contact the Easemob business team, because this operation deletes all configurations related to advanced features.**
