...
Before using Reactions, activate the feature in [Easemob Console](https://console.easemob.com/user/login). For instructions, see the [Easemob Console documentation](/product/console/basic_message.html#消息表情回复).
...
3. Activate the Reaction feature in [Easemob Console](https://console.easemob.com/user/login).
