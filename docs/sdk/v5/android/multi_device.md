...
EasyIM allows the same account to log in on multiple devices. Before using this feature, activate the multi-device login service in [EasyIM Console](https://console.easyim.ai/user/login). For details, see the [EasyIM Console documentation](/product/console/basic_user.html#multi-device-login).
...
- Activate multi-device login in [EasyIM Console](https://console.easyim.ai/user/login). For details, see the [EasyIM Console documentation](/product/console/basic_user.html#multi-device-login).
