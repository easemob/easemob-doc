...
- JDK 17 or later
- A valid EasyIM developer account and App Key. See [Easemob Console](https://console.easemob.com/user/login).
...
To obtain the value corresponding to the App Key, create an app in [Easemob Console](https://console.easemob.com/user/login), apply for an App Key, and complete the relevant configuration.
