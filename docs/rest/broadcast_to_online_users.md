...
| 403      | forbidden_op | online user broadcast limit exceeded | The daily API call limit, 50 calls by default, has been exceeded. | Contact the business manager to increase the frequency limit. |
