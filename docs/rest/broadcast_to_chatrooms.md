...
| 403      | forbidden_op | chatroom broadcast limit exceeded  | The daily API call limit, 100 calls by default, has been exceeded. | Contact the business manager to increase the frequency limit. |
