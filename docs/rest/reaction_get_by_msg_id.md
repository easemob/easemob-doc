...
To use Reaction, activate it in the [EasyIM Console](https://console.easyim.ai/user/login). For details, see the [EasyIM Console documentation](/product/console/basic_message_conversation.html#message-reactions).
