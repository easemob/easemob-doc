...
| :------------ | :------- | :----------------------------------------------------------- |
| `muc_id`      | String   | Unique identifier on the server of the chat group where the webhook event occurs, `{appkey}_{group ID}@conference.easemob.com`. |
| `reason`      | String   | /                                                            |
...
| Field     | Type | Description                                                         |
| :------- | :------- | :----------------------------------------------------------- |
| `callId`    | String   | `callId` is the unique identifier of each webhook request, in the format “App Key_chat group creation event message ID”. |
| `msg_id`    | String   | Chat group creation event message ID. |

Chat group creation webhook request example:
...
| Field          | Type | Description                                                         |
| :------------ | :------- | :----------------------------------------------------------- |
| `muc_id`      | String   | Unique identifier on the server of the chat group or chat room where the webhook event occurs, `{appkey}_{group/chat room ID}@conference.easemob.com`. |
| `reason`      | String   | /                                                            |
...
| Field     | Type | Description                                                         |
| :------- | :------- | :----------------------------------------------------------- |
| `callId`    | String   | `callId` is the unique identifier of each webhook request, in the format “App Key_chat group destruction event message ID”. |
| `msg_id`    | String   | Chat group destruction event message ID. |

Chat group destruction webhook request example:
...
Chat room destruction webhook request example:

Fields outside the payload are described in the following table:

| Field     | Type | Description                                                         |
| :------- | :------- | :----------------------------------------------------------- |
| `callId`    | String   | `callId` is the unique identifier of each webhook request, in the format “App Key_chat room destruction event message ID”. |
...
| Field     | Type | Description                                                         |
| :------- | :------- | :----------------------------------------------------------- |
| `callId`    | String   | `callId` is the unique identifier of each webhook request, in the format “App Key_user application to join a chat group event message ID”. |
...
| Field          | Type | Description                                                         |
| :------------ | :------- | :----------------------------------------------------------- |
| `muc_id`      | String   | Unique identifier on the server of the chat group where the webhook event occurs, `{appkey}_{group/chat room ID}@conference.easemob.com`. |
| `reason`      | String   | /                                                            |
| `is_chatroom` | Bool     | Whether this is a chat room. <br/> - `true`: Yes;<br/> - `false`: No.                 |
...
| Field     | Type | Description                                                         |
| :------- | :------- | :----------------------------------------------------------- |
| `callId`    | String   | `callId` is the unique identifier of each webhook request, in the format “App Key_approval of a user's application to join a chat group event message ID”. |
...
| Field     | Type | Description                                                         |
| :------- | :------- | :----------------------------------------------------------- |
| `callId`    | String   | `callId` is the unique identifier of each webhook request, in the format “App Key_new user invitation to join a chat group event message ID”. |
...
| Field     | Type | Description                                                         |
| :------- | :------- | :----------------------------------------------------------- |
| `callId`    | String   | `callId` is the unique identifier of each webhook request, in the format “App Key_invited user acceptance of a chat group invitation event message ID”. |
...
| Field     | Type | Description                                                         |
| :------- | :------- | :----------------------------------------------------------- |
| `callId`    | String   | `callId` is the unique identifier of each webhook request, in the format “App Key_invited user rejection of a chat group invitation event message ID”. |
...
| Field     | Type | Description                                                         |
| :------- | :------- | :----------------------------------------------------------- |
| `callId`    | String   | `callId` is the unique identifier of each webhook request, in the format “App Key_user removal from a chat group or chat room event message ID”. |
| `msg_id`    | String   | User removal from a chat group or chat room event message ID. |

Chat group member removal webhook request example:
...
Chat room member removal webhook request example:
...
| Field     | Type | Description                                                         |
| :------- | :------- | :----------------------------------------------------------- |
| `callId`    | String   | `callId` is the unique identifier of each webhook request, in the format “App Key_user addition to the group blocklist event message ID”. |
| `msg_id`    | String   | User addition to the group blocklist event message ID. |

Webhook request example for banning a chat group member by adding them to the blocklist:
...
| Field     | Type | Description                                                         |
| :------- | :------- | :----------------------------------------------------------- |
| `callId`    | String   | `callId` is the unique identifier of each webhook request, in the format “App Key_user removal from the group blocklist event message ID”. |
...
| Field     | Type | Description                                                         |
| :------- | :------- | :----------------------------------------------------------- |
| `callId`    | String   | `callId` is the unique identifier of each webhook request, in the format “App Key_chat group or chat room information modification event message ID”. |
| `msg_id`    | String   | Chat group or chat room information modification event message ID. |

Chat group information modification webhook request example:
...
Chat room information modification webhook request example:
...
| Field     | Type | Description                                                         |
| :------- | :------- | :----------------------------------------------------------- |
| `callId`    | String   | `callId` is the unique identifier of each webhook request, in the format “App Key_chat group block event message ID”. |
| `msg_id`    | String   | Chat group block event message ID. |

Chat group block webhook request example:
...
| Field     | Type | Description                                                         |
| :------- | :------- | :----------------------------------------------------------- |
| `callId`    | String   | `callId` is the unique identifier of each webhook request, in the format “App Key_chat group unblock event message ID”. |
...
| Field     | Type | Description                                                         |
| :------- | :------- | :----------------------------------------------------------- |
| `callId`    | String   | `callId` is the unique identifier of each webhook request, in the format “App Key_new member joining a chat group or chat room event message ID”. |
...
When a new member joins a chat group, EasyIM sends your app server a notification that the user joined the chat group. Webhook request example:
...
When a new member joins a chat room, EasyIM sends your app server a notification that the user joined the chat room. Webhook request example:
...
| Field     | Type | Description                                                         |
| :------- | :------- | :----------------------------------------------------------- |
| `callId`    | String   | `callId` is the unique identifier of each webhook request, in the format “App Key_member leaving a chat group or chat room event message ID”. |
...
When a member voluntarily leaves or is removed from a chat group, EasyIM sends your app server a notification that the user left the chat group. Webhook request example:
...
When a member voluntarily leaves or is removed from a chat room, EasyIM sends your app server a notification that the user left the chat room. Webhook request example:
...
| Field     | Type | Description                                                         |
| :------- | :------- | :----------------------------------------------------------- |
| `callId`    | String   | `callId` is the unique identifier of each webhook request, in the format “App Key_member voluntarily leaving a chat group or chat room event message ID”. |
| `msg_id`    | String   | Member voluntarily leaving a chat group or chat room event message ID. |

Chat group member voluntary leave webhook request example:
...
Chat room member voluntary leave webhook request example:
...
| Field     | Type | Description                                                         |
| :------- | :------- | :----------------------------------------------------------- |
| `callId`    | String   | `callId` is the unique identifier of each webhook request, in the format “App Key_chat group ownership transfer event message ID”. |
| `msg_id`    | String   | Chat group ownership transfer event message ID. |

Chat group ownership transfer webhook request example:
...
| Field     | Type | Description                                                         |
| :------- | :------- | :----------------------------------------------------------- |
| `callId`    | String   | `callId` is the unique identifier of each webhook request, in the format “App Key_chat group or chat room admin addition event message ID”. |
| `msg_id`    | String   | Chat group or chat room admin addition event message ID. |

Chat group admin addition webhook request example:
...
Chat room admin addition webhook request example:
...
| Field     | Type | Description                                                         |
| :------- | :------- | :----------------------------------------------------------- |
| `callId`    | String   | `callId` is the unique identifier of each webhook request, in the format “App Key_chat group or chat room admin removal event message ID”. |
| `msg_id`    | String   | Chat group or chat room admin removal event message ID. |

Chat group admin removal webhook request example:
...
Chat room admin removal webhook request example:
...
| Field     | Type | Description                                                         |
| :------- | :------- | :----------------------------------------------------------- |
| `callId`    | String   | `callId` is the unique identifier of each webhook request, in the format “App Key_chat group or chat room member mute event message ID”. |
| `msg_id`    | String   | Chat group or chat room member mute event message ID. |

Chat group member mute webhook example:
...
Chat room member mute webhook example:
...
| Field     | Type | Description                                                         |
| :------- | :------- | :----------------------------------------------------------- |
| `callId`    | String   | `callId` is the unique identifier of each webhook request, in the format “App Key_chat group or chat room member unmute event message ID”. |
| `msg_id`    | String   | Chat group or chat room member unmute event message ID. |

Chat group member unmute webhook request example:
...
Chat room member unmute webhook request example:
...
| Field     | Type | Description                                                         |
| :------- | :------- | :----------------------------------------------------------- |
| `callId`    | String   | `callId` is the unique identifier of each webhook request, in the format “App Key_chat group or chat room announcement update event message ID”. |
...
| Field     | Type | Description                                                         |
| :------- | :------- | :----------------------------------------------------------- |
| `callId`    | String   | `callId` is the unique identifier of each webhook request, in the format “App Key_chat group or chat room announcement deletion event message ID”. |
| `msg_id`    | String   | Chat group or chat room announcement deletion event message ID. |

Chat group announcement deletion webhook request example:
...
Chat room announcement deletion webhook request example:
...
| Field     | Type | Description                                                         |
| :------- | :------- | :----------------------------------------------------------- |
| `callId`    | String   | `callId` is the unique identifier of each webhook request, in the format “App Key_chat group shared file upload event message ID”. |
| `msg_id`    | String   | Chat group shared file upload event message ID. |

Chat group shared file upload webhook request example:
...
| Field     | Type | Description                                                         |
| :------- | :------- | :----------------------------------------------------------- |
| `callId`    | String   | `callId` is the unique identifier of each webhook request, in the format “App Key_chat group shared file deletion event message ID”. |
| `msg_id`    | String   | Chat group shared file deletion event message ID. |

Chat group shared file deletion webhook request example:
...
| Field     | Type | Description                                                         |
| :------- | :------- | :----------------------------------------------------------- |
| `callId`    | String   | `callId` is the unique identifier of each webhook request, in the format “App Key_user addition to the chat group or chat room allowlist event message ID”. |
| `msg_id`    | String   | User addition to the chat group or chat room allowlist event message ID. |

Webhook request example for adding a user to the group allowlist:
...
Webhook request example for adding a user to the chat room allowlist:
...
| Field     | Type | Description                                                         |
| :------- | :------- | :----------------------------------------------------------- |
| `callId`    | String   | `callId` is the unique identifier of each webhook request, in the format “App Key_user removal from the chat group or chat room allowlist event message ID”. |
| `msg_id`    | String   | User removal from the chat group or chat room allowlist event message ID. |

Webhook request example for removing a user from the group allowlist:
...
Webhook request example for removing a user from the chat room allowlist:
...
| Field     | Type | Description                                                         |
| :------- | :------- | :----------------------------------------------------------- |
| `callId`    | String   | `callId` is the unique identifier of each webhook request, in the format “App Key_chat group or chat room global mute event message ID”. |
| `msg_id`    | String   | Chat group or chat room global mute event message ID. |

Chat group global mute webhook request example:
...
Chat room global mute webhook request example:
...
| Field     | Type | Description                                                         |
| :------- | :------- | :----------------------------------------------------------- |
| `callId`    | String   | `callId` is the unique identifier of each webhook request, in the format “App Key_chat group or chat room global unmute event message ID”. |
| `msg_id`    | String   | Chat group or chat room global unmute event message ID. |

Chat group global unmute webhook request example:
...
Chat room global unmute webhook request example:
...
| Field          | Type | Description                                                         |
| :------------ | :------- | :----------------------------------------------------------- |
| `muc_id`      | String   | Unique identifier on the server of the chat room where the webhook event occurs, `{appkey}_{chat room ID}@conference.easemob.com`. |
| `is_chatroom` | Bool     | Whether this is a chat room. <br/> - `true`: Yes;<br/> - `false`: No. |
...
| Field     | Type | Description                                                         |
| :------- | :------- | :----------------------------------------------------------- |
| `callId`    | String   | `callId` is the unique identifier of each webhook request, in the format “App Key_chat room custom attribute setting or update event message ID”. |
...
Chat room custom attribute setting or update webhook request example:
...
| Field     | Type | Description                                                         |
| :------- | :------- | :----------------------------------------------------------- |
| `callId`    | String   | `callId` is the unique identifier of each webhook request, in the format “App Key_chat room custom attribute deletion event message ID”. |
| `msg_id`    | String   | Chat room custom attribute deletion event message ID. |
| `from`    | String   | Chat room ID. |
| `to`    | String   | User ID of a chat room member. |

Chat room custom attribute deletion webhook request example:
...
| Field          | Type | Description                                                         |
| :------------ | :------- | :----------------------------------------------------------- |
| `muc_id`      | String   | Unique identifier on the server of the chat room where the webhook event occurs, `{appkey}_{group ID}@conference.easemob.com`. |
| `is_chatroom` | Bool     | Whether this is a chat room. <br/> - `true`: Yes;<br/> - `false`: No. |
...
| Field     | Type | Description                                                         |
| :------- | :------- | :----------------------------------------------------------- |
| `callId`    | String   | `callId` is the unique identifier of each webhook request, in the format “App Key_custom chat group member attribute setting event message ID”. |
...
Custom chat group member attribute setting webhook request example:
