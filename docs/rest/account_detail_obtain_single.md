...
|  - `notification_display_style`         | Int    | The push notification display mode:<br/> - `0`: Notification only. The push title is “You've got a new message”, and the push content is “Please click to view”.<br/> - `1`: Notification with message details. The push title is “You've got a new message”, and the push content consists of the sender's nickname and the offline message content.<br/>If the user has not set this parameter, it is not returned in the response. |
