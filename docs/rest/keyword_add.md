...
- You can also configure and use keywords in the [EasyIM Console](https://console.easyim.ai/user/login). For details, see [Keyword moderation](/value-added/moderation/moderation_keyword.html#add-keywords).
