...
Retrieves the announcement for the specified chat room ID.
...
| :------------------ | :----- | :--------------- |
| `data` | JSON | Retrieved chat room announcement information. |
| - `announcement` | String | Chat room announcement content. |
