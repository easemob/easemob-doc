...
- The [group owner](/sdk/v5/android/group_members.html#transfer-chat-group-ownership) or [chat room owner](/sdk/v5/android/room_members.html#transfer-chat-room-ownership) is changed on the client.
