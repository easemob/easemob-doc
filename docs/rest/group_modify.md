...
| `maxusers`            | Int    | No       | Maximum number of chat group members, including the group owner. If the value exceeds `3000`, offline push is no longer supported by default. To enable offline push, contact the Easemob business team for activation. |
