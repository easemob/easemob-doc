...
- Delete a keyword list.
- You can also delete a keyword list in the [Easemob Console](https://console.easemob.com/user/login): Select **EasyIM** > **Content Moderation** > **Text Moderation** > **Keyword Lists**.
