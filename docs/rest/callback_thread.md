...
- A message in a message thread is [sent](/sdk/v5/android/thread_message.html#send-messages-in-a-message-thread), [recalled](/sdk/v5/android/thread_message.html#recall-messages-in-a-message-thread), or [edited](/sdk/v5/android/message_modify.html) on the client.
