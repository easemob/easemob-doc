...
- In the [EasyIM Console](https://console.easyim.ai/user/login), you can also [query keyword lists](/value-added/moderation/moderation_keyword.html#configure-keyword-lists).
