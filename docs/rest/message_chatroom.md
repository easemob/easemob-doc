...
- Calling this API triggers a post-delivery callback event. For details, see [Callback events](callback_message_send.html#send-group-messages).
...
2. Roaming for targeted chat room messages is disabled by default. Before use, contact the sales team to activate chat room message roaming and targeted message roaming.
:::
