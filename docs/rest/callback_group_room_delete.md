# Chat Group and Chat Room Deletion Callback

## Feature overview

After a chat group or chat room is deleted successfully, the EasyIM server sends a callback request to your app server according to the [post-delivery callback rules](/product/console/basic_webhook.html#configure-message-callback-rules). Your app server can use the callback to synchronize data.
