...
- Remove multiple users from the group blocklist.
- Up to 60 users can be removed at one time.
...
| `usernames`  | String    |  Yes       | The user ID to be removed from the group blocklist. |
