...
Create offline push message templates, including the default **default** and **detail** templates and custom templates. You can also create push templates in the [Easemob Console](https://console.easemob.com/user/login). For details, see [Push template configuration](/document/android/push/push_template.html#feature-activation).
