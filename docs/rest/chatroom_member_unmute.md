...
| :----------- | :--- | :------------- | :----------- | :----------- |
| 400     | invalid_parameter | removeMute member size more than max limit :  60 | The number of users unmuted in a batch exceeds the limit of 60. | Reduce the number of users to 60 or fewer. |
