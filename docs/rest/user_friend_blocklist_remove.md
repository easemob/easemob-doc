...
- Removing a stranger from the blocklist restores the state in which the users are not friends. If friendship verification is disabled, the two users can send and receive messages normally.
