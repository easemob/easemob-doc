...
| 403      | message_rewrite_error   | The rewrite message feature is not open.   | The message editing feature is not enabled.  | Contact the Easemob business team to enable message editing.  |
