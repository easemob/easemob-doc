...
- In the [EasyIM Console](https://console.easyim.ai/user/login), you can also [delete keywords in batches](/value-added/moderation/moderation_keyword.html#delete-keywords).
