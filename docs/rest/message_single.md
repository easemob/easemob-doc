...
| `ext`   | JSON   | No       | Messages support extension fields for adding custom information. This parameter cannot be `null`. Push notifications also support custom extension fields. For details, see [APNs custom display](/sdk/v5/ios/push/push_display_field.html) and [Android push fields](/sdk/v5/android/push/push_display_field.html). |
