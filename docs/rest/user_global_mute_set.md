...
| 403 | forbidden_op | user_mute is not used for this app | The global mute feature is not activated. | Activate this feature in the Easemob Console. For details, see [Easemob Console documentation](/product/console/basic_user.html#global-user-mute). |
