...
- You can also modify a keyword list in the [Easemob Console](https://console.easemob.com/user/login): Select **EasyIM** > **Content Moderation** > **Text Moderation** > **Keyword Lists**.
