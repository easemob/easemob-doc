...
| 计费模式 | 免费版支持 100 个注册用户，超出后自动按专业版计费 | 按月峰值 DAU 计费，750 元/1万 DAU（开通即包含 1万 DAU）           | 按月峰值 DAU 计费，2250 元/1万 DAU（开通即包含 1万 DAU）  |
...
| 价格 | 计费项     | 说明 |
| :--- | :----- | :------- |
| 2250 元/月  | - 推送日活：≤ 10,000 设备（免费峰值） <br/> - 推送速度：10,000 条/秒   | 支持高并发业务场景，保障大规模用户实时触达。|
...
| 计费项   | 价格             | 说明                             |
| :------- | :--------------- | :------------------------------- |
| 推送日活 | 2250 元/万/月 | 按超出套餐的推送日活用户数计费。 |

### 扩展功能

| 功能项       | 价格        | 说明                                                       |
| :----------- | :---------- | :--------------------------------------------------------- |
| 推送速度提升 | 450 元/月 | 每提升 1000 条/秒推送速度，收取 450 元/月，支持叠加购买。 |
