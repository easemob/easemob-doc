...
- 已完成 [SDK 初始化](/document/applet/initialization.html)，并成功 [登录](/document/applet/login.html)。
- 已联系商务开通语音转文字服务。
- 已具备 [发送](/document/applet/message_send.html#发送语音消息) 和 [接收语音消息](/document/applet/message_receive.html#接收语音消息) 的基础集成能力。
