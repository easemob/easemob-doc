...
- [IM SDK] 优化聊天室自定义属性更新的回调方法 `chatroomAttributesDidRemoved`，返回修改成功的聊天室自定义属性的集合。 
- [IM SDK] 优化聊天室自定义属性移除的回调方法 `chatroomAttributesDidRemoved`，返回成功移除的聊天室自定义属性的 key 数组。
