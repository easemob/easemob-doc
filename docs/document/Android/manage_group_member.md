...
- 了解群成员角色，详见 [群组概述](https://docs-im.easemob.com/ccim/android/group1)；
...
根据创建群组时的群组类型 (`EMGroupStyle`) 和进群邀请是否需要对方同意 (`EMGroupOptions#inviteNeedConfirm`) 设置，群组加人的处理逻辑有差别。具体规则可以参考[创建群组](https://docs-im.easemob.com/ccim/android/group2#%E6%96%B0%E5%BB%BA%E7%BE%A4%E7%BB%84)。
...
或者也可以用 [获取群组详情](https://docs-im.easemob.com/ccim/android/group2#获取群组详情) 获取群组管理员列表。
...
- [群组概述](https://docs-im.easemob.com/ccim/android/group1)
- [创建和管理群组以及监听器介绍](https://docs-im.easemob.com/ccim/android/group2)
- [群属性管理](https://docs-im.easemob.com/ccim/android/group4)
