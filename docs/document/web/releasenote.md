...
1. 支持 [查询当前用户已加入的群组数量](group_manage.html#查询当前用户已加入的群组数量)。
2. 支持 [屏蔽群消息](group_manage.html#屏蔽群消息)、[解除屏蔽群消息](group_manage.html#解除屏蔽群消息)和 [检查当前用户是否已经屏蔽群消息](group_manage.html#检查当前用户是否已经屏蔽群消息)。
