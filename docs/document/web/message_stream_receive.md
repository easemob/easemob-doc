...
| [消息漫游](/document/web/message_retrieve.html#从服务器获取指定会话的消息)         | 是                                |
| [消息扩展](/document/web/message_extension.html)         | 是                                |
| [定向发送](/document/web/message_target.html)         | 否                                |
| [消息已读回执](/document/web/message_receipt.html)     | 否                                |
| 消息输入状态 | 否                                |
| [消息回复（Reaction）](/document/web/reaction.html)         | 是                                |
| [消息置顶](/document/web/message_pin.html)         | 是                                |
| [消息撤回](/document/web/message_recall.html)         | 是                                |
| [消息单向删除](/document/web/message_delete.html#单向删除服务端的历史消息)     | 是                                |
