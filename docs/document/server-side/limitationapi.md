...
| * 发送单聊流式消息                 | POST   | /{org_name}/{app_name}/stream_message/user           | 100 条/秒/App Key   | 50 条/秒   | 
| * 发送群聊流式消息                 | POST   | /{org_name}/{app_name}/stream_message/chatgroup           | 100 条/秒/App Key   | 50 条/秒   | 
