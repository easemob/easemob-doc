...
- 创建关键词名单。
- 关键词名单为增值服务，在 [文本审核规则](/value-added/moderation/moderation_rule_config.html#设置审核规则) 中应用。使用前，你需要开通 [文本审核服务](/value-added/moderation/moderation_enable.html), 配置 [文本审核规则](/value-added/moderation/moderation_rule_config.html#设置审核规则)，并开通 [关键词名单服务](/value-added/moderation/moderation_keyword#使用关键词审核)。
