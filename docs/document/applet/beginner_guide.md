...
<img src=/images/applet/beginner_guide.png  width="400" height="550"/>
...
| [集成 SDK](/document/applet/wechat.html)         | 将 SDK [集成到你的项目](/document/applet/wechat.html)中：<br/> - 搭建微信小程序开发环境<br/> - 配置服务器域名<br/> - 下载和引入 SDK <br/> - 实例化 SDK|
| [初始化 SDK](/document/applet/initialization.html)  | 使用 IM 的各项功能前，必须先初始化。[初始化](/document/applet/initialization.html) 时，需传入你的 App Key，配置设备 ID、最大重连次数、是否支持通过自己的路径将图片、文件上传到自己的服务器等重要特性。|
| [登录 IM](/document/applet/login.html)       | 使用创建的用户登录 IM。登录成功后，你可以使用 IM 的功能。 |
| 集成特性         | 集成主要特性：<br/> - [消息管理](/document/applet/message_send.html) <br/> - [会话管理](/document/applet/conversation_overview.html)<br/> - [群组管理](/document/applet/group_overview.html) <br/> - [聊天室管理](/document/applet/room_overview.html) <br/> - [用户管理](/document/applet/user_relationship.html)<br/> - [小程序离线推送](/document/applet/push/push_overview.html)：环信 IM 小程序 SDK 本身不支持离线推送，只支持对移动端离线推送配置。<br/> - [使用 Uni-app 离线推送插件](/document/applet/push/uniapp_push.html)：|
