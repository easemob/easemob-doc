...
| [初始化 SDK](/document/applet/initialization.html)         | 使用 IM 的各项功能前，必须先初始化。传入你应用的 App Key 进行 [初始化](/document/applet/initialization.html)。 初始化时，可配置自动登录、加群、退群推送等重要特性。|
| [登录 IM](/document/applet/login.html)       | 使用创建的用户登录 IM。登录成功后，你可以使用 IM 的功能。 |
| 集成特性         | 集成主要特性：<br/> - [消息管理](/document/applet/message_send.html) <br/> - [会话管理](/document/applet/conversation_overview.html)<br/> - [群组管理](/document/applet/group_overview.html) <br/> - [聊天室管理](/document/applet/room_overview.html) <br/> - [用户管理](/document/applet/user_relationship.html)<br/> - [离线推送](/document/applet/push/push_overview.html)|
