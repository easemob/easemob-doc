...
| 使用限制| 默认 | 描述 | 
| :--------- | :----- | :------- | 
| 功能开通   | 关闭   | 仅专业版及以上版本支持群消息已读回执功能。若要使用该功能，需在[环信即时通讯云控制台](https://console.easemob.com/user/login)开通。    | 
...
| 群规模    |  500 人   | 该特性最大支持 500 人的群组，即群组中每条消息最多可返回 500 条已读回执。 <br/>消息的已读回执数量超过 500 条时，最新的已读回执记录会覆盖最早的记录。  | 
