...
| [`addListener`](#添加在线状态监听器) | `EMPresenceManager` | 注册在线状态监听器。 |
| [`removeListener`](#添加在线状态监听器) | `EMPresenceManager` | 移除在线状态监听器。 |
| [`clearListeners`](#添加在线状态监听器) | `EMPresenceManager` | 清空在线状态监听器。 |
| [`onPresenceUpdated`](#添加在线状态监听器) | `EMPresenceListener` | 接收被订阅用户的在线状态更新。 |
