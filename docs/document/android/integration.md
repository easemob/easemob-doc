...
2. 请点击查看私有化[发版说明](releasenote.html)获得最新版本号。
...
打开 [SDK 下载页面](https://www.easemob.com/download/im)，获取私有化版本支持的环信即时通讯 IM Android SDK，然后解压。
...
1. 打开 [SDK 下载页面](https://www.easemob.com/download/im)，获取私有化版本支持的环信即时通讯 IM Android SDK，然后解压。
