...
The default data center is **Singapore**. You can also select **US East 1** or **Germany 2**. To use Singapore 2, contact the EasyIM business manager.
...
| :---------- | :--------------------------------------------------------- |
| Singapore 1 | `im-api-sgp-v2.easemob.com` or `im-api-sgp-v2.easecdn.com` |
| Singapore 2 | `msync-api-61.easemob.com` or `msync-api-61.easecdn.com`   |
| US East 1   | `msync-api-41.easemob.com` or `msync-api-41.easecdn.com`    |
| Germany 2   | `msync-api-71.easemob.com` or `msync-api-71.easecdn.com`   |

### RESTful API addresses

The following table lists the RESTful API request addresses for each data center:

| Cluster name    | RESTful API request address                         |
| :---------- | :------------------------------------------- |
| Singapore 1 | `a1-sgp.easemob.com` or `a1-sgp.easecdn.com` |
| Singapore 2 | `a61.easemob.com` or `a61.easecdn.com`       |
| US East 1   | `a41.easemob.com` or `a41.easecdn.com`       |
| Germany 2   | `a71.easemob.com` or `a71.easecdn.com`       |

### WeChat Mini Program addresses

The following table lists the WeChat Mini Program addresses for each cluster:

| Cluster name    | WeChat Mini Program                                                   |
| :---------- | :----------------------------------------------------------- |
| Singapore 1 | `im-api-wechat-sgp.easemob.com` or `im-api-wechat-sgp.easecdn.com` |
| Singapore 2 | `im-api-wechat-61.easemob.com` or `im-api-wechat-61.easecdn.com` |
| US East 1   | `im-api-wechat-41.easemob.com` or `im-api-wechat-41.easecdn.com` |
| Germany 2   | `im-api-wechat-71.easemob.com` or `im-api-wechat-71.easecdn.com` |

:::tip
Under data privacy agreements, after selecting Singapore 1, Singapore 2, US East 1, or Germany 2, you cannot migrate to another cluster.
:::
...
#### 2. Can I migrate between data centers?

Under data privacy agreements, after selecting Singapore 1, Singapore 2, US East 1, or Germany 2, you cannot migrate to another cluster.

#### 3. When do I need acceleration?

If your end users are located both inside and outside the Chinese mainland and frequently exchange messages across countries, we recommend activating acceleration to improve the cross-region access experience.

#### 4. What is the default bandwidth of an acceleration node, and can I adjust it?

The default bandwidth of an acceleration node is **1 Mbps**. If your business traffic is higher, you can configure more bandwidth based on your requirements. Contact the EasyIM business manager for details.

#### 5. Do I need to configure different addresses for each data center on each client?
