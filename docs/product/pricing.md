...
| 群聊消息已读回执   | 功能介绍详见[群聊消息已读回执](/document/android/message_receipt.html#消息已读回执)。     | 预付费   | 1000 元/月     | — |
...
[订阅套餐包时](#订阅套餐包)，你可以在 **即时通讯IM 服务版本** 页面订阅增值服务。
...
2. 查看各套餐包的功能详情，根据业务需要选择套餐包，选择 **我已阅读并同意《环信云服务购买协议》**，点击 **立即购买**，完成支付。

**方法二**

1. 在[环信控制台](https://console.easemob.com/user/login)，选择 **即时通讯** > **功能配置** > **功能配置总览**。
2. 点击对应功能的 **操作** 一栏的 **升级**，进入**即时通讯IM 服务版本** 页面。
3. 查看各套餐包的功能详情，根据业务需要选择套餐包，选择 **我已阅读并同意《环信云服务购买协议》**，点击 **立即购买**，完成支付。
