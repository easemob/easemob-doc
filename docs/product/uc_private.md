...
<div class="alert note"><li>若要体验环信即时通讯 IM 的功能，可下载[公有云 Demo](https://www.easemob.com/download/demo)。<li>若要体验私有化 Demo，需下载下表中对应平台的 Demo，然后在登录页面的`服务器配置`区域完成配置。<li>若要集成，需选择下表中的 SDK 及 Demo 版本，按照下表中“开发指南”一列的文档配置私有化环境信息。</div>
