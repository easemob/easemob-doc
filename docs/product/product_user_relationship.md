...
联系人列表相关的限制，如单个用户的好友数上限，详见[产品使用限制](/product/limitation.html#用户关系)。
...
1. 在环信即时通讯云的左侧导航栏中，选择 **应用概览** > **应用详情**的**应用设置**区域。
2. 在 **应用设置** 区域，点击 **好友关系检查**对应的 **打开**，则该功能的状态为**已开启**。若关闭该功能，点击 **关闭**。
