...
// TODO：下图是腾讯云的，需要改成环信的

| 功能类型     | 功能描述                                                     |
| ------------ | ------------------------------------------------------------ |
| 全球接入简介 | 即时通信 IM 提供覆盖全球的高连通、高可靠、强安全的网络连接通道，自研多重最优寻址算法，具有全网调度能力，终端在境外登录时，IM SDK 会访问就近接入点或加速点 |
| 中国         | 华南、华北、华东、中国香港、中国台湾等                       |
| 境外         | 亚洲：日本、韩国、新加坡、泰国、马来西亚、越南、菲律宾、阿联酋、印度尼西亚欧洲：德国、英国、法国、意大利、挪威、西班牙、荷兰北美洲：美国、加拿大、墨西哥南美洲：巴西大洋洲：澳大利亚非洲：南非、尼日利亚等 |
...
| 命令消息       | 通过发送命令给对方，通知对方要执行的操作，对方收到消息后系统可以自定义处理。<br/> 透传消息不会在 UI 上展示，也不存入本地数据库。 |
...
// TODO：产品价格也针对群组总数和聊天室总数，写的是无限制，但这两个的总数又有限制，冲突吗？
...
| 群组/聊天室总数上限  | <br/> - 体验版：100 <br/> - 专业版：无限制  <br/> - 旗舰版：无限制  | <br/> -体验版：不支持 <br/> - 专业版：无限制  <br/> - 旗舰版：无限制     |
| 成员数上限          | <br/> -体验版：100 人/群 <br/> - 专业版：300人/群（可调*）  <br/> - 旗舰版：3000人/群（可调*） | <br/> -体验版：不支持 <br/> - 专业版：10,000 人/聊天室  <br/> - 旗舰版：10,000 人/聊天室    // TODO：聊天室这部分需要核实一下 |
| 成员列表   | 所有成员均可见     | 所有成员均可见      |
| 创建   | 所有 app 用户都可以创建群组     | 仅聊天室超级管理员可在客户端创建     |
| 解散   | 群主     | 聊天室所有者     |
| 申请加入         | 支持     | 支持    |
| 加群审批         | 支持     | 支持     |
| 邀请加入         |  支持    | 支持   // TODO：聊天室是否支持  |
| 群主/所有者退出         | 不支持     | 支持     |
| 设置管理员         | 支持      | 支持     |
| 移除成员         | <br/> - 群主 <br/> - 群管理员  // TODO：是否还写 app 管理员（应该是通过 RESTful API）  | <br/> - 聊天室所有者 <br/> - 聊天室管理员     |
| 成员禁言          | 支持     | 支持     |
| 白名单          | 支持     | 支持     |
| 黑名单         | 支持     | 支持     |
...
| 订阅增值服务  | 开通消息回调、全局禁言等[增值服务](/product/pricing.html#增值服务费用)                  | 
| 账户中心  | 查看订单记录和消费账单                  | 
