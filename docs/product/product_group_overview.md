...
| 最大成员数   | 默认3000人，如需提升该上限，请联系商务。| 默认支持 10,000 人，如需提升该上限，请联系商务。 |
...
| 功能               | 描述  |
| :----------------- | :---------------------- |
| 创建群组           | 任何用户都可以创建群组。群组创建者为群主。群组创建时可以指定群组名称、头像、描述，是否是公开群、要加入群组的用户列表、是否需要审批、普通成员是否能邀请新用户加入群组，以及群扩展信息等。 |
