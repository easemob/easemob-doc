...
To improve project security, EasyIM uses tokens, which are dynamic keys, to authenticate users who are about to log in to the instant messaging system. EasyIM RESTful APIs support only app token authentication. For details, see [Authenticate with an App Token](/rest/easemob_app_token.html).

### REST API overview

#### Delete a user account

[Delete a specified user from an app](/rest/account_delete_single.html). The deleted user data mainly includes the user's conversation list, user attributes, and friend relationships.

#### Delete user attributes

[Delete the user attributes of a specified user from an app](/rest/user_attribute_delete.html).

#### Destroy a chat group

[Delete the chat group with a specified chat group ID from an app](/rest/group_delete.html).

#### Destroy a chat room

[Delete the chat room with a specified ID from an app](/rest/chatroom_delete.html).
...
| [Chat group member list](/rest/group_member_list_obtain.html) | Retrieve the member list of a chat group with a specified chat group ID in an app.    |
| [Chat group announcement](/rest/group_announcement_obtain.html) | Retrieve the announcement of a chat group with a specified chat group ID in an app.       |
| [Chat group shared files](/rest/group_shared_file_obtain.html) | Retrieve the shared files of a chat group with a specified chat group ID in an app.   |
| [Chat group blocklist](/rest/group_member_blocklist_obtain.html) | Retrieve the blocklist of a chat group with a specified chat group ID in an app. |
| [Chat group mute list](/rest/group_member_mutelist_obtain.html) | Retrieve the mute list of a chat group with a specified chat group ID in an app.   |
...
| [Chat room admin list](/rest/chatroom_admin_list_get.html) | Retrieve the admin list of a chat room with a specified chat room ID in an app. |
| [Chat room member list](/rest/chatroom_member_list_obtain.html) | Retrieve the member list of a chat room with a specified chat room ID in an app.   |
| [Chat room mute list](/rest/chatroom_member_mutelist_obtain.html) | Retrieve the mute list of a chat room with a specified chat room ID in an app.   |
