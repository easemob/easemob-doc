...
| [Maximum chat groups per user](/product/console/basic_single_group_chat.html#maximum-chat-groups-per-user) | Maximum number of chat groups that a user can join | Prepaid | Increased to 2000: $140/month | Increased to 5000: $140/month |
...
| [Request quality monitoring](/product/console/operation_troubleshooting_request_quality.html) | Provides real-time, fine-grained monitoring of endpoint request quality worldwide. | Prepaid | $280/month | $280/month |
