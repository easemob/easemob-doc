...
在发起上线前，建议先根据业务需求选择上线方式：

- 如果你希望保留测试数据，选择 **原测试版应用直接升级为正式版**。
- 如果你希望测试环境和正式环境隔离，选择 **创建新的正式版应用**。

如果你暂时无法判断，建议先查看文末的 [上线事项对照表](#上线事项)，再提交上线申请。
...
3. 在 **申请上线** 对话框中 [选择应用上线方式](#选择上线方式)，并按需填写正式版应用信息。
...
// TODO：测试版中订阅了内容审核服务，两种方式的上限都没有看到该服务的费用信息。
