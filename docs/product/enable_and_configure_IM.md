...
1. 登录环信即时通讯云控制台，在首页的**应用列表**区域点击 **添加应用** 按钮，创建即时通讯 IM 应用。
...
| 请选择服务版本           |  当 App Key 为免费版时，可购买专业版、旗舰版或尊享版，不可单独购买增值服务。<br/>当 App Key 为专业版时，可购买旗舰版、尊享版或单独购买增值服务。<br/>当 App Key 为旗舰版时，可购买尊享版或单独购买增值服务。<br/>当 App Key 为尊享版时，仅支持单独购买增值服务。|
...
<td width="274">
<p>环信即时通讯 IM 为每个公司（组织）分配的唯一标识。该参数是 `APPKEY` 的一部分。</p>
</td>
<td rowspan="3" width="184">
<p>在环信即时通讯云控制台的首页上，在<strong>应用列表</strong>区域中点击目标应用的 <strong>操作</strong> 栏中的 <strong>查看</strong>，进入 <strong>应用详情</strong> 页面。</p>
</td>
</tr>
<tr>
<td width="94">
...
<td width="274">
<p>你在环信即时通讯云控制台创建应用时填入的应用名称。该参数是 `AppKey` 的一部分。</p>
</td>
</tr>
<tr>
<td width="94">
...
<td width="274">
<p>应用的唯一标识，由 `Orgname` 和 `Appname` 组成，生成后不允许修改。</p>
</td>
</tr>
<tr>
<td width="94">
...
<td width="274">
<p>RESTful API 请求域名。环信为应用提供的 REST API 和 WebSocket 的请求域名。</p>
</td>
<td rowspan="2" width="184">
<p>在环信即时通讯云控制台的首页上，在 <strong>应用列表</strong> 区域中点击目标应用的 <strong>操作</strong> 栏中的 <strong>查看</strong>。在左侧导航栏选择 <strong>即时通讯 &gt; 服务概览</strong>，进入 <strong>服务概览</strong> 页面。</p>
</td>
</tr>
<tr>
<td width="94">
...
<td width="274">
<p>环信 IM 提供的分布在全球的多个数据中心：</p>
<p>l&nbsp; 国内数据中心：</p>
<p>&Oslash;&nbsp; 北京 1 区</p>
<p>&Oslash;&nbsp; 北京 Vip6 区</p>
<p>l&nbsp; 海外数据中心</p>
<p>&Oslash;&nbsp; 新加坡 1 区</p>
<p>&Oslash;&nbsp; 法兰克福，德国</p>
<p>&Oslash;&nbsp; 弗吉尼亚，美国</p>
...
在环信即时通讯云控制台的首页的 **应用列表** 中，点击目标应用的 **操作** 栏中的 **查看** 按钮，在左侧导航栏选择 **即时通讯** > **功能配置** > **功能配置总览**，您可以查看到当前 App Key 的服务配置并根据实际业务需求管理相关配置。
...
4. 增值服务：点击**单独购买增值服务**，进入增值服务购买页面，根据实际需求选择购买。
...
2. 在弹出的 **消息撤回时间设置** 对话框中，设置消息可撤回时长。端消息撤回时长和 REST 消息撤回时长均不能超过 7天。
3. 单击 **确定** 保存配置。
...
2. 在左侧导航栏，依次点击 **即时通讯** > **功能配置** > **消息推送** > **证书管理**，进入 **证书管理** 页面。
