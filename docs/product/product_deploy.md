...
当服务端验证完成后，可通过下载需要的客户端 SDK 及 Demo 进行集成体验。环信客户端 SDK 已对 IM 核心服务完成封装， 通过调用 SDK API 接口，即可快速获得消息收发 、会话管理 、群组 、好友 、聊天室等功能。目前客户端 SDK 已覆盖 Windows 、Linux 、MacOS 、Android 、iOS 、Web 、小程序等多种平台，服务器端 SDK 已覆盖 Java 、PHP 等平台，见SDK/REST集成。
...
<img src="/images/privitization/deploy_android_custom_server.jpg" width="300"/>
...
- appkey：easemob-test#test
- 使用自定义服务器：开启
- IM server：私有化服务器主机地址
- IM Port：msync 端口，6717
- Rest server 地址&端口：Rest api 地址

<img src="/images/privitization/deploy_ios_custom_server.jpg" width="300"/>
...
<img src="/images/privitization/deploy_wechat_code.jpg" width="200" />
