...
使用环信即时通讯 IM 提供的 AI 机器人聊天。你需要在[环信即时通讯控制台](/product/enable_and_configure_IM)开通 AI 智能功能，创建机器人，即实现与机器人的**单聊**功能。

此外，你可以在[环信即时通讯控制台](/product/enable_and_configure_IM)查看机器人账号消耗的 token 数和消耗趋势。
