...
环信即时通讯 IM iOS Demo 提供用户登录、单聊、群组、消息话题、消息(文字、表情、语音、视频、图片、文件等)发送及管理、会话管理、好友管理、用户属性、用户在线状态（Presence）以及实时音视频通话等功能。
...
- 上传头像并返回地址。
- 根据用户的信息生成 [EaseCallKit](https://doc.easemob.com/callkit/ios/easecallkit.html) 登录所需的 Token。
