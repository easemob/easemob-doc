...
| [登录 IM](/v4/ios/login.html)       | 使用创建的用户登录 IM，包括 [主动登录](/v4/ios/login.html#主动登录) 和 [自动登录](/v4/ios/login.html#自动登录)。登录成功后，你可以使用 IM 的功能。 |
