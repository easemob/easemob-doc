...
### 步骤 3 初始化 EaseCallUIKit  // TODO：Android 用的是 CallKit，需要统一

你可以在应用程序加载时或使用前初始化 EaseCallUIKit。初始化主要包含以下步骤：
...
// TODO：在整个应用生命周期中，初始化一次即可。  各端是否需要添加这个？
...
// TODO：各端是否统一编写呼叫页面，Android 编写了登录和呼叫页面，iOS 未编写。
// TODO：iOS 这里是语音通话还是视频通话？
// TODO：Android 还添加了测试应用
...
// TODO：快速开始需要这些吗？
- 若要配置画中画，详见 [视频通话画中画文档](PictureInPicture.html)。
- 若要配置 LiveCommunicationKit，详见 [LiveCommunicationKit 文档](LiveCommunicationKit.html)。