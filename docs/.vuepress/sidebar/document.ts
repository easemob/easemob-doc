  ...
  },
  {
    ...
    children: [
      { 
        ...
        collapsible: true,
        children: [
          { text: '离线推送概述', link: 'push_overview.html', only: ['android', 'ios', 'web','harmonyos'] },
          { 
            text: '集成第三方推送', 
            collapsible: true,
            children: [
          ...
          { text: '设置通知方式和免打扰', link: 'push_notification_mode_dnd.html', only: ['android', 'ios', 'web']},
          ...
          { text: 'FAQ', link: 'push_solution.html', only: ['android', 'ios','harmony']},
        ]
      },
  ...
  },
  {
    ...
    children: [
      { text: '离线推送', 
        collapsible: true,
        children: [
        { text: '离线推送概述', link: 'push_overview.html' }, 
