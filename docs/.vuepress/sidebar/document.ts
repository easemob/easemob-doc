...
//     text: '快速开始',
//     children: [
//       { text: 'React Demo（WebIM）体验', link: 'demo_react.html' },
//       { text: 'Vue Demo（WebIM）体验', link: 'demo_vue.html' },
//       { text: 'Demo（EaseIM App）体验', link: 'demo.html' },
//       { text: '快速开始', link: 'quickstart.html' },
//       { text: 'SDK 集成概述', link: 'overview.html' },
//       { text: '私有云 SDK 集成配置', link: 'privatecloud.html' },
...
//       { text: 'EaseIMKit 使用指南', link: 'easeimkit.html' },
//       { text: 'EaseCallKit 使用指南', link: 'easecallkit.html' }
//     ]
//   },
//   {
//     text: '产品介绍',
...
//     children: [
//       {
//         text: 'Uniapp 生成原生 Android、iOS 应用',
//         link: 'uniappnativeapp.html'
//       },
...
//     ]
//   },
//   { text: '错误码', children: [ { text: '错误码', link: 'error.html' } ] },
//   {
//     text: '设置回调',
//     children: [
