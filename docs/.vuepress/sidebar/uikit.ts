...
const chatUikitSidebar = [
  ...
  { text: "集成单群聊 UIKit", link: "chatuikit_integrated.html", only: ["android", "harmonyos", "react-native", "flutter"] },
  { text: "会话列表", link: "chatuikit_conversation.html", only: ["android", "harmonyos", "react-native", "flutter"]},
  { text: "消息", link: "chatuikit_chat.html", only: ["android", "harmonyos", "react-native", "flutter"]},
  { text: "通讯录", link: "chatuikit_contactlist.html", only: ["android", "harmonyos", "react-native", "flutter"]},
