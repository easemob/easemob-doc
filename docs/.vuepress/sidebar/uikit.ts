...
const chatUikitSidebar = [
  ...
  { text: "集成单群聊 UIKit", link: "chatuikit_integrated.html", only: ["react-native", "flutter"] },
  {
      ...
      collapsible: true,
      children: [
        { text: "创建页面", link: "chatuikit_converation_list_create.html" },
        { text: "自定义页面", link: "chatuikit_conversation.html" },
      ],
    only: ["android", "harmonyos"],
  },
  { text: "会话列表", link: "chatuikit_conversation.html", only: ["react-native", "flutter"]},
  {
      text: "消息",
      collapsible: true,
      children: [
        { text: "创建页面", link: "chatuikit_chat_create.html" },
        { text: "自定义页面", link: "chatuikit_chat.html" },
      ],
    only: ["android", "harmonyos"],
  },
  { text: "消息", link: "chatuikit_chat.html", only: ["react-native", "flutter"]},
  {
      text: "通讯录",
      collapsible: true,
      children: [
        { text: "创建页面", link: "chatuikit_contact_list_create.html" },
        { text: "自定义页面", link: "chatuikit_contactlist.html" },
      ],
    only: ["android", "harmonyos"],
  },
  { text: "通讯录", link: "chatuikit_contactlist.html", only: ["react-native", "flutter"]},
