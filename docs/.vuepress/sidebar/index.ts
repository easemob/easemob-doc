...
import DOC_SIDEBAR_V1 from "./document_v1"
import DOC_SIDEBAR_V2 from "./document_v2"
...
export const zhSidebar = sidebar({
  ...
  '/product/': [
    ...
    },
    {
      text: '内容审核',
      children: [
        { text: '产品简介', collapsible: true, children: [
        ...
        { text: '常见问题', collapsible: true, children: [
          ...
          { text: '为什么处置方式选择了替换***，但实际被拦截了没有发出来？', link: 'moderation/moderation_replace_refuse.html' },
        ]},  
      ]
    },
    {
