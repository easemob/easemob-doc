  ...
  "/product/": [
          ...
          children: [
            {
              ...
              children: [
                {
                  text: "用户注册与登录",
                  link: "product_user_registration_login.html",
                },
      ...
      children: [
        {
          ...
          children: [
            ...
            {
              text: "架构与示例项目",
              link: "aigc_solution/aigc_architecture.html",
            },
            {
              text: "服务端配置",
              link: "aigc_solution/aigc_run_through_demo_server.html",
            },
            {
              text: "客户端配置",
              link: "aigc_solution/aigc_run_through_demo_client.html",
            },
          ],
        },
        {
    ...
    //},
    {
      ...
      children: [
        ...
        {
          text: "SDK合规使用说明",
          link: "https://www.easemob.com/news/privacy",
        },
      ],
    },
    // {
          ...
          children: [
            {
              ...
              children: [
                ...
                {
                  text: "会话/群组/聊天室",
                  link: "console/basic_conversation_group_chatroom.html",
                },
            ...
            },
            {
              ...
              children: [
                {
                  text: "内容审核",
                  link: "console/value_added_config_moderation.html",
                },
                {
                  text: "即时推送",
                  link: "console/value_added_config_push.html",
                },
                {
                  text: "实时音视频",
                  link: "console/value_added_config_rtc.html",
                },
              ],
            },
          ],
              ...
              children: [
                {
                  ...
                  children: [
                    {
                      text: "绑定 MFA 设备",
                      link: "console/account_security_mfa_bind.html",
                    },
                    {
                      text: "解绑 MFA 设备",
                      link: "console/account_security_mfa_unbind.html",
                    },
                  ],
                },
                {
                  text: "登录保护",
                  link: "console/account_security_protection_login.html",
                },
                {
                  text: "操作保护",
                  link: "console/account_security_protection_operation.html",
                },
                {
                  text: "修改账户密码",
                  link: "console/account_security_password_change.html",
                },
                {
                  text: "修改手机号和邮箱",
                  link: "console/account_security_mobile_email.html",
                },
              ],
            },
            {
              text: "找回账户密码",
              link: "console/account_password_retrieve.html",
            },
          ...
          children: [
            ...
            },
            {
              ...
              children: [
                ...
                {
                  text: "消息量统计",
                  link: "console/operation_message_statistics.html",
                },
              ],
            },
            {
              ...
              children: [
                {
                  text: "请求质量监控",
                  link: "console/operation_troubleshooting_request_quality.html",
                },
                {
                  text: "消息投递查询",
                  link: "console/operation_troubleshooting_message_delivery.html",
                },
                {
                  text: "用户连接状态查询",
                  link: "console/operation_troubleshooting_user_connection.html",
                },
                {
                  text: "用户设备日志",
                  link: "console/operation_troubleshooting_device_log.html",
                },
                {
                  text: "聊天室消息速率",
                  link: "console/operation_troubleshooting_chatroom_rate.html",
                },
              ],
            },
          ],
