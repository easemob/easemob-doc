...
- Allowed recipients to receive modified extension information from the sender when a message is updated: Added the `ext` field to the message modification event `onModifiedMessage`.
...
- Supported custom device platforms.
