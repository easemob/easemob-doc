...
- **通用特性**
  ...
  - 发送打赏消息：用户通过赠送虚拟礼物，向聊天室中的主播或其他用户表达赞赏或者支持
...
- **消息管理**
  - 举报消息：在聊天室中，用户可以举报不适当、违规或有害的消息内容以促使聊天室所有者采取适当的行动。
  - 翻译消息：将聊天室中的单条消息从一种语言转换成另一种语言。
  - 撤回消息：在聊天室中撤销已经发送的消息。所有用户只能撤回自己发送的消息，即使聊天室所有者也不能撤回其他成员发送的消息。
