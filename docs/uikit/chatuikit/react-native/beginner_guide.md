...
![img](/images/harmonyos/beginner_guide.png)
...
| [集成 UIKit](chatuikit_integrated.html)  | 将单群聊 UIKit [集成到你的应用](chatuikit_integrated.html)：<br/> - 集成单群聊 UIKit SDK npm 包 <br/> - 集成 UI 组件：初始化和设置主题<br/> - 设置国际化 <br/> - 使用路由<br/> - 使用安全区域组件<br/> - 集成会话列表和联系人列表组件<br/> - 集成聊天页面  |
| 自定义页面        | 若默认的聊天或会话列表等页面无法满足你的要求，你可以自定义页面，例如，[消息列表的头像和昵称](chatuikit_chat.html#消息列表的头像和昵称) 和 [自定义消息列表项样式](chatuikit_chat.html#自定义消息列表项样式)等。<br/> - [自定义会话列表页面](chatuikit_conversation.html)<br/> - [自定义聊天页面](chatuikit_chat.html)<br/> - [自定义通讯录页面](chatuikit_contactlist.html)<br/> - [自定义联系人详情页面](chatuikit_custom_contact_details.html)<br/> - [自定义群详情页面](chatuikit_custom_group_details.html)|
