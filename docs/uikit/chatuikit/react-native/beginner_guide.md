...
| [集成 UIKit](chatuikit_integrated.html)  | 将单群聊 UIKit [集成到你的应用](chatuikit_integrated.html)：<br/> - 集成单群聊 UIKit SDK npm 包 <br/> - 集成 UI 组件：初始化和设置主题<br/> - 设置国际化 <br/> - 使用路由<br/> - 使用安全区域组件<br/> - 集成会话列表和好友列表组件<br/> - 集成聊天页面  |
