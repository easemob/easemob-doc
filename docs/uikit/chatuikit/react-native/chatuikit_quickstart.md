...
```sh
npx @react-native-community/cli@latest init --skip-install --version "0.83.2" simple_uikit_demo # 推荐创建稳定版本示例
```
...
- 在 **应用概览** 页面 [获取 App Key](/product/console/app_manage.html#管理应用)。
