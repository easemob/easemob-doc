...
![img](/images/uikit/chatuikit/web/page_chat.png =500x550) 

- ConversationList 提供会话列表容器。

![img](/images/uikit/chatuikit/web/page_conversation.png =400x900) 

- ContactList 提供联系人、群组及其详情等容器。

![img](/images/uikit/chatuikit/web/page_contact_list.png =400x900) 
