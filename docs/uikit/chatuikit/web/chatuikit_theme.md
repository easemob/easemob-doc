...
你可以从 [GitHub](https://github.com/easemob/easemob-uikit-react/blob/dev/common/style/themes/default.scss) 或 [Gitee](https://gitee.com/easemob-code/easemob-uikit-react/blob/dev/common/style/themes/default.scss) 中查看定义的变量。
